...
export class InfermaryAdmissionController {
  constructor(private readonly infermaryAdmissionService: InfermaryAdmissionService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateInfermaryAdmissionDto: UpdateInfermaryAdmissionDto) {
    return this.infermaryAdmissionService.update(+id, updateInfermaryAdmissionDto);
  }
